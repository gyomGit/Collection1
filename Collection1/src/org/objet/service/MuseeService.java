 ...
 * 
 *         Interface de la couche service Musee du modèle DAO de l'application 
 *         'Collection'
 */
public interface MuseeService {

	/**
	 * Méthode servant à passer une requète de type Insert à la couche DAO du
	 * modèle DAO.
	 * 
	...
	/**
	 * Méthode servant à passer une requète de type Delete à la couche DAO du
	 * modèle DAO.
	 * 
	...
	/**
	 * Méthode servant à passer une requète de type Update à la couche DAO du
	 * modèle DAO.
	 * 
